namespace OfflineImageProcessingApp
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            var pixelWidth = inputImageSize.Width * 2;
            var pixelHeight = inputImageSize.Height * 2;
            ...
            var gaussianBlurEffect = new d2.Effects.LinearTransfer(d2dContext);
            gaussianBlurEffect.SetInput(0, bitmapSourceEffect.Output, true);

            // Effect 2 : Scale Effect
            var scaleClass = new d2.Effects.Scale(d2dContext);
            scaleClass.SetInput(0, bitmapSourceEffect.Output, false);
            var centerPoint = new SharpDX.Vector2(0, 0);
            var newSize = new SharpDX.Vector2(2.0f, 2.0f);
            ...
            var textToDraw = "This is demo of DirectX Scale Effect in C#";
            ...
            d2dContext.DrawTextLayout(new SharpDX.Vector2(5f, 5f), textLayout, textBrush);
            d2dContext.EndDraw();
